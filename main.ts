...
function setGoals () {
    ...
    for (let value5 of tiles.getTilesByType(assets.tile`tile19`)) {
        gem = sprites.create(img`
    ...
    for (let value6 of tiles.getTilesByType(assets.tile`tile6`)) {
        gem = sprites.create(img`
    ...
    for (let value8 of tiles.getTilesByType(assets.tile`tile7`)) {
...
game.onUpdate(function () {
    if (player.tileKindAt(TileDirection.Center, assets.tile`tile26`) || player.tileKindAt(TileDirection.Center, assets.tile`tile27`) || player.tileKindAt(TileDirection.Center, assets.tile`tile28`)) {
        ...
        if (player.isHittingTile(CollisionDirection.Bottom)) {
            ...
            if (isClimbing && (player.tileKindAt(TileDirection.Left, assets.tile`tile26`) || player.tileKindAt(TileDirection.Right, assets.tile`tile26`))) {
                isClimbing = false
                player.ay = gravity
                controller.moveSprite(player, 100, 0)
                atTopOfLadder = false
            }
            if (isClimbing && player.tileKindAt(TileDirection.Center, assets.tile`tile26`)) {
                player.ay = 0
                atTopOfLadder = true
                ...
                if (player.tileKindAt(TileDirection.Center, assets.tile`tile28`)) {
                    isClimbing = true
                    player.ay = 0
                    player.vy = 0
                    controller.moveSprite(player, 0, 50)
